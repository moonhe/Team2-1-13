...
Schema.createSchema = function(mongoose) {
	...
	AdminSchema.method('authenticate', function(plainText, inSalt, hashed_password) {
		if (inSalt) {
	...
	AdminSchema.method('checkValidation', function() {
	...
	// 스키마에 static 메소드 추가
	AdminSchema.static('findByEmail', function(email, callback) {
	...
	AdminSchema.static('load', function(options, callback) {
